...
{
    public const MAX_FILE_BYTES =
        5 * 1024 * 1024;

    public const MAX_ROWS = 5000;

    public const MAX_COLUMNS = 17;
    ...
    public function __construct(
        private HardwarePriceManager $manager
    ) {
    }
    ...
    public function import(
        ...
        if (
            ...
            throw new RuntimeException(
                'The CSV file is missing or exceeds the 5 MB limit.'
            );
        }
        ...
        while (
            ...
            if (
                ...
                $result['errors'][] = [
                    'row' => $rowNumber,
                    'message' =>
                        'A cell exceeds the 2,000 character limit.',
                ];
    ...
    private function readHeader(
        ...
        if (
            ...
            throw new RuntimeException(
                'The CSV header is missing or has too many columns.'
            );
        }
